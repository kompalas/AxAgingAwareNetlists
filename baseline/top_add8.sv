...
module top ( a_i_0, a_i_1, p_o );
  ...
  NAND2_X4 U33 ( .A1(a_i_0[1]), .A2(a_i_1[1]), .ZN(n61) );
  NAND2_X4 U34 ( .A1(a_i_0[0]), .A2(a_i_1[0]), .ZN(n21) );
  ...
  NAND2_X1 U71 ( .A1(n62), .A2(n61), .ZN(n63) );
